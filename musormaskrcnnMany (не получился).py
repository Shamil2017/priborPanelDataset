    ...
    def extract_boxes(filename):
        ...
        for object in root.findall('.//object'):
            ...
            for name in object.findall('.//name'):
                nameWithoutText = re.sub(r'[^a-zA-Z]', '', name.text)
                box_class_list.append(nameWithoutText)
...
print(filename[11:-4])
filename = 'brake13'
print(re.sub(r'[^a-zA-Z]', '', filename))



dataset_dir = 'priborPanelDataset'
        is_train = False
...
class MusorDataset(Dataset):
    ...
    def load_mask(self, image_id):
        ...
        for i in range(len(boxes)):
            ...
            if (boxes[i][1] == 'accomulator'):
                masks[row_s:row_e, col_s:col_e, i] = 1
                class_ids.append(self.class_names.index(boxes[i][1]))   #'Accomulator'
            if (boxes[i][1] == 'brake'):
                masks[row_s:row_e, col_s:col_e, i] = 2
                class_ids.append(self.class_names.index(boxes[i][1]))   #'Brake'
...
# load image
image = load_img('accumulator55.jpeg')
...
draw_image_with_boxes('accumulator23.jpeg', yhat[0]['rois'])
